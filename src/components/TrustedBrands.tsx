  ...
  return (
    <section className="py-12 bg-background border-b border-border/40 overflow-hidden" id="trusted-brands">
      ...
      <div className="relative flex overflow-x-hidden group">
        ...
        <div className="flex animate-marquee items-center gap-12 whitespace-nowrap min-w-full z-0 group-hover:[animation-play-state:paused]">
          
          {/* Repeat array twice for smooth infinite scroll */}
          {[...brandLogos, ...brandLogos].map((src, index) => (
            <div key={index} className="w-[120px] md:w-[150px] shrink-0 opacity-60 hover:opacity-100 transition-opacity flex items-center justify-center grayscale hover:grayscale-0">
